    ...
    <div class="space-y-4">
        @forelse ($appointments as $appointment)
            <div wire:key="appointment-{{ $appointment->id }}"
                ...
                @if ($flashId === $appointment->id) ring-2 ring-emerald-300 animate-pulse @endif">
                ...
                <div class="mt-3 grid gap-1 text-sm">
                    ...
                    <div class="mt-2 flex items-center justify-between">
                        ...
                        <p class="rounded-full bg-[var(--accent-soft)] px-3 py-1 text-sm font-medium">
                            ${{ number_format($appointment->service->price_cents / 100, 2) }}
                        </p>
                    </div>
                </div>
        ...
        @empty
            <div class="rounded-2xl border border-[var(--line)] bg-[var(--card)] p-6 text-center text-[var(--muted)]">
                No appointments yet.
            </div>
        @endforelse
